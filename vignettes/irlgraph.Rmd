...
dm <- c("40", "60", "80", "100")
coordmat <- matrix(c(rbind(seq(0.5, 38.5, 0.5), 0.5), rbind(0.5, seq(0.5, 12.5, 0.5))), byrow = TRUE, ncol = 2)
...
times <- lapply(1:length(dm), function(x) system.time(irl_acc(dm[[x]],            poicoords = matrix(c(10.5, 10.5), ncol = 2), grainprop = 0.25, costsurf = costsurfs[[x]],
