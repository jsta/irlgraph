...
```{r eval=FALSE, fig.align='left', fig.height=3.2, fig.width=4.6}
...
plot(cbind(unlist(fullvertxedges), fulltimes), ylim = c(0.2, 60), xlim = c(0, 8e+08), 
  log = "y", ylab = "Processing Times (s)", xlab = "Landscape graph vertices x edges", main = paste0(nrow(coordmat), " starting nodes"))
